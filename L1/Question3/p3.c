...
void removeRed(int **red,int **blue,int **green, int x, int y);

//! remove Blue shade from the image
void removeBlue(int **red,int **blue,int **green, int x, int y);

//! remove Green shade from the image
void removeGreen(int **red,int **blue,int **green, int x, int y);

//! preserve only red shade in the image
void preserveRed(int **red,int **blue,int **green, int x, int y);

//! preserve only Blue shade in the image
void preserveBlue(int **red,int **blue,int **green, int x, int y);

//! preserve only Green shade in the image
void preserveGreen(int **red,int **blue,int **green, int x, int y);
    ...
    while(1){
        ...
        switch(op) {
            ...
            case 2: //! remove red shade from the image
                    start = clock ();
                    removeGreen(red,blue,green,x,y);
                    end = clock();
                    cpu_time = ((double) (end - start)) / CLOCKS_PER_SEC;
                    printf("cpu time used %f\n", cpu_time);
                    break;
            ...
            case 5: //! preserve only Blue shade in the image
                    start = clock ();
                    preserveBlue(red,blue,green,x,y);
                    end = clock();
                    cpu_time = ((double) (end - start)) / CLOCKS_PER_SEC;
                    printf("cpu time used %f", cpu_time);
                    break;
            ...
            case 6: //! preserve only Green shade in the image
                    start = clock ();
                    preserveGreen(red,blue,green,x,y);
                    end = clock();
                    cpu_time = ((double) (end - start)) / CLOCKS_PER_SEC;
                    printf("cpu time used %f\n", cpu_time);
                    break;
            ...
            case 7: //! print current value of RGB in pixel at given point 
                    ...
                    start = clock ();
                    pixelValue(x,y,red,blue,green,x,y);
                    end = clock();
                    cpu_time = ((double) (end - start)) / CLOCKS_PER_SEC;
                    printf("cpu time used %f\n", cpu_time);
                    break;
...
void removeRed(int **red,int **blue,int **green , int i, int j){
    if(red[i][j]>blue[i][j]&&red[i][j]>green[i][j])
                    red[i][j]=0;
}

void removeBlue(int **red,int **blue,int **green , int i, int j){
